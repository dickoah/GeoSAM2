...
from ._common import (_extract_basecolor_texture_image, _quantize_rgb,
                      _weld_index, _welded_face_incidence, _welded_face_pairs,
                      load_mesh)
...
def split_glb_by_texture_palette_rgb(
    ...
    scene = load_mesh(in_glb_path, force="scene")
